export const skillGroups = [
  ...
  },
  {
    ...
    capabilities: [
      ...
      "Docker, Linux, and reproducible research workflows",
    ],
    softwareSkills: [
      { skillName: "LaTeX", iconifyTag: "logos:latex" },
      { skillName: "Docker", iconifyTag: "simple-icons:docker" },
      { skillName: "Linux", iconifyTag: "logos:linux-tux" },
      { skillName: "GitHub", iconifyTag: "mdi:github" },
    ],
  },
];
